---
title: "Venlaflaxine - microbiome beta diversity analysis"
author: "Milena Esser"
date: "2025-05-20"
output:
  html_document: 
...
load("R_analysis/18S/R_output/ps_objects/Venla_biofilm_phyloseq_filt_rar.RData")

# css-normalized dataset "ps_biofilm_css"
load("R_analysis/18S/R_output/ps_objects/Venla_biofilm_phyloseq_filt_css.RData")

# TSS-normalized dataset "ps_biofilm_prop"
load("R_analysis/18S/R_output/ps_objects/Venla_biofilm_phyloseq_filt_propnorm.RData")
```

\# Create output directory

output_dir \<- here::here("R_output", "Beta_diversity", dataset)
...
output_dir <- file.path("R_analysis/18S/R_output", "Beta_diversity", dataset)
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)
```
...
#save plot as pdf
filename <- file.path(output_dir, paste0("Beta_Dispersion_across_Invertebrate_treatmentgroups_", dataset, ".pdf"))
ggsave(filename = filename, height = 5, width = 8)
