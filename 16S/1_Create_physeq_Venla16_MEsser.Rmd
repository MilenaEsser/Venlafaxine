...
output_dir <- "R_analysis/16S/R_output"
...
```{r}
# Read data
tree <- read_qza("R_analysis/16S/data/rooted-tree.qza")
otus <- read_qza("R_analysis/16S/data/16S_table.qza")
taxonomy <- read_qza("R_analysis/16S/data/taxonomy.qza")
...
ps_dir <- file.path("R_analysis" , "16S", "R_output", "ps_objects")
