...
load("R_analysis/16S/R_output/ps_objects/Venla_water_phyloseq_filt_unnorm.RData")
load("R_analysis/16S/R_output/ps_objects/Venla_sediment_phyloseq_filt_unnorm.RData")

# Create output directory
output_dir <- "R_analysis/16S/R_output/taxabarplot"
...
```{r plot-water-fam, results='asis', fig.height=6, fig.width=12}
#### STEP 1: Aggregate and transform to relative abundance ####
