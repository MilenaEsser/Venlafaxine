---
title: "Venlafaxine - microbiome beta diversity analysis"
author: "Milena Esser"
date: "2025-05-20"
output:
  html_document: 
...
load("R_analysis/16S/R_output/ps_objects/Venla_biofilm_phyloseq_filt_css.RData")

# TSS-normalized dataset "ps_biofilm_prop"
load("R_analysis/16S/R_output/ps_objects/Venla_biofilm_phyloseq_filt_propnorm.RData")
```
...
output_dir <- file.path("R_analysis/16S/R_output", "Beta_diversity", dataset)
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)
```
